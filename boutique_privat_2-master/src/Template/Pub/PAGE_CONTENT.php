...
<head>
    ...
    <link rel="stylesheet" href="<?= \Base\BaseApp::getBaseLink() ?>Styles/css/jquery.fancybox.min.css" />
    <script type="text/javascript" src="<?= \Base\BaseApp::getBaseLink() ?>Styles/js/jquery.fancybox.min.js"></script>
    <script type="text/javascript" src="<?= \Base\BaseApp::getBaseLink() ?>Styles/js/tab.js"></script>
    <script type="text/javascript" src="<?= \Base\BaseApp::getBaseLink() ?>Styles/js/product.js"></script>
    <script type="text/javascript" src="<?= \Base\BaseApp::getBaseLink() ?>Styles/js/Rating/rating.js"></script>
